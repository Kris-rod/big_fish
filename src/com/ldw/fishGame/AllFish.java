...
public class AllFish {
	...
	private int sp=ra.nextInt(6)+1;

	public AllFish() {
		fish = ra.nextInt(15)+1;
		...
		img2l = new ImageIcon(this.getClass().getResource("otherfish2.png"));
		img2r = new ImageIcon(this.getClass().getResource("otherfish2_副本.png"));
